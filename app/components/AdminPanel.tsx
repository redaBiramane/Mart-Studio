...
// ============================================================
// Gestion des questions de l'atelier (pilotées par l'admin)
// ============================================================
function QuestionsManager() {
  ...
  return (
    <div className="context-card" style={{ padding: 28, marginTop: 28 }}>
      <h3 style={{ fontSize: 20, fontWeight: 800, color: 'var(--primary)', marginBottom: 6 }}>Questions de l&apos;atelier</h3>
      <p style={{ color: 'var(--text-secondary)', fontSize: 14, lineHeight: 1.6, marginBottom: 18 }}>
        Définissez les questions que <strong>Marty</strong> pose à chaque étape. Elles sont enregistrées côté serveur et <strong>injectées dans le contexte de Marty</strong> (prioritaires sur les questions par défaut) et affichées comme suggestions.
      </p>
